	...
	<div class="container">
		<script type="text/javascript">
			...
			$(document).ready(function() {
				//alert("${pageContext.request.contextPath}/newboard/updateboard/${bseq}")
				...
				$.ajax({
					...
					, url:"${pageContext.request.contextPath}/newboard/updateboard/${bseq}/${board_detail_dto.board_id}"
					, data : form
					, processData : false
					, contentType : false
					, cache : false
		...
		<h2> ${board_detail_dto.bname} update</h2>
		<form id="form1">
			<table class="table table-hover">
				<tr>
					<th>제목</th>
					<td><input type="text" id="bname" name="bname" class="form-control" maxlength="50"  value="${board_detail_dto.bname}" readonly></td>
				</tr>
				<tr>
					<th>작성자</th>
					<td><input type="text" id="member_login_id" name="member_login_id" class="form-control" value="${board_detail_dto.member_login_id}" readonly></td>
				</tr>
				<tr>
					<th>내용</th>
